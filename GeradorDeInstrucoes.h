//
// Created by rogerd on 04/07/18.
//

#ifndef TP2_2906_GERADORDEINSTRUCOES_H
#define TP2_2906_GERADORDEINSTRUCOES_H
...
void geradorInstrucoes(int i) {
    ...
    int quant_for = TAM_INST / TAM_FOR;
...
#endif //TP2_2906_GERADORDEINSTRUCOES_H
